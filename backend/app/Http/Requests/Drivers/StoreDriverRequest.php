...
class StoreDriverRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'identity_document' => ['required', 'string', 'max:50', 'unique:drivers,identity_document'],
            'tss_worker_code' => ['required', 'string', 'max:40', 'unique:drivers,tss_worker_code'],
            ...
            'license.license_number' => ['nullable', 'string', 'max:50', 'unique:driver_licenses,license_number'],
